...
import pandas as pd
                                        ...
                                        ## To Add External CSS ##
with open('D:/lic/css/style.css') as f:
...
medicines_dict = pickle.load(open('D:\lic\medicine_dict.pkl','rb'))
medicines = pd.DataFrame(medicines_dict)

                    # To load similarity-vector-data from pickle in the form of dictionary
similarity = pickle.load(open('D:\lic\similarity.pkl','rb'))
...
image = Image.open('lic/images/medicine-image.jpg')
